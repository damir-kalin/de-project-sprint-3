...
generate_report >> get_report >> get_increment >> [upload_user_order_inc, upload_user_activity_log_inc, upload_customer_research_inc] 
upload_user_order_inc >>[update_d_item_table, update_d_city_table]
